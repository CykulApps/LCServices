...
public class MonthlyFragment extends Fragment {
    ...
    private void sendDataToServer(final String fname, final String lname, final String mno, final int down, final int drent, final int dkids, final int dactivity, final int totalCount, final String totalAmount, final String curTime, final String radioType, final String cardNum) {
